<template>
    <div class="EC-colorContentPrimary d-flex" v-if="lugaggeData.checkedBag">
    ...
    <div class="EC-colorContentPrimary d-flex" v-if="lugaggeData.boardBag">
        <v-icon icon="mdi-bag-personal" size="x-small" class="enableContent"></v-icon>
        <v-icon icon="mdi-bag-carry-on" size="x-small" class="enableContent"></v-icon>
    ...
    <div class="EC-colorContentPrimary d-flex" v-if="lugaggeData.personalBag">
