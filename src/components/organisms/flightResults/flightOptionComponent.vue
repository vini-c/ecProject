    ...
    <section class="flightOptionCard rounded-lg pb-4 " v-for="(item, x) in flightOptionData" :key="x">
        <section class="foCard">
            <div class="foResumeContent">
                <div class="foHeader"  v-if="confirmation === false">
                ...
                <div class="foHeader"  v-if="confirmation">
                    ...
                    <div class="confirmationIllustration">
                        <div class="divider"></div>
                                <v-img class="planeConfirmationLogo"
                                    width="36"
                                    :aspect-ratio="1"
                                    src="@/assets/ec_plane.svg"
                                    ></v-img>
                                </div>
        ...
        <div class="foBodyDetailsBar pt-3">
            <div class="detailsfoFlightInfo d-flex"   v-if="confirmation === false">
